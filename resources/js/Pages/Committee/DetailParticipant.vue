...
watch(search, (value) => {
  router.get(
    "/committee/participant/list-participant-class-room",
    { search: value },
    {
      preserveState: true,
      replace: true,
...
function detailPeserta(data) {
  ...
  form.address = data.participant?.profile?.address;
  form.image = data.participant?.image;
  form.poster = data.schedule?.poster;
  form.class_room = data.schedule?.class_room?.name;
  form.category = data.schedule?.category?.name;
...
function toggleCheckbox(id) {
  ...
  if (props.participant.to == totalChecked) {
...
function checkedAll() {
  ...
  if (checboxAll.checked == true) {
    ...
    props.participant.data.forEach((data) => {
              ...
              <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                >
                  <div>
                    <!-- icon plus -->
                    <div
                      @click="showModal(props.participant.data)"
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(item, index) in props.participant.data"
                      :key="index"
                    ...
                    >
                      <td class="px-6 py-4">
                        <div class="flex flex-col items-center">
                            <div>
                                <img :src="item.participant?.image" :alt="item.participant?.name" srcset="">
                            </div>
                            <div>
