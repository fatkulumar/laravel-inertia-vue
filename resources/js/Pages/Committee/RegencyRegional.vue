...
function addRegencyRegional() {
  form.post("/committee/regency-regional/store", {
    preserveScroll: true,
    onSuccess: () => {
      resetForm();
...
function deleteRegencyRegional(id, name) {
  ...
  if (!konfirm) return;
  form.delete(`/committee/regency-regional/delete/${id}`, {
    preserveScroll: true,
    onSuccess: (e) => {
      toast("success", "Berhasil");
      resetForm();
...
function deleteRegencyRegionalDestroy() {
  ...
  if (!konfirm) return;
  formCheckbox.post("/committee/regency-regional/destroy", {
    preserveScroll: true,
    onSuccess: () => {
      formCheckbox.id = [];
