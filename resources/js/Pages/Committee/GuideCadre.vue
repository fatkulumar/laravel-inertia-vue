...
function addGuideCadre() {
  form.post("/committee/guide-cadre/store", {
    preserveScroll: true,
    onSuccess: () => {
      resetForm();
...
function deleteGuideCadreDestroy() {
  ...
  if (!konfirm) return;
  formCheckbox.post("/committee/guide-cadre/destroy", {
    preserveScroll: true,
    onSuccess: () => {
      formCheckbox.id = [];
            ...
            <div class="p-6 text-gray-900">
              <div class="overflow-x-auto shadow-md sm:rounded-lg">
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(item, index) in props.guideCadres.data"
                      :key="index"
      ...
      >
        <div class="relative p-4 w-full max-w-7xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form @submit.prevent="addGuideCadre" class="p-4 md:p-5">
              <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2">
                  ...
                  <select
                    ...
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  >
                    <option value="" :selected="form.type_activity_id == ''">
                      Pilih Jenis Kegiatan
                    </option>
                    <option
                      v-for="(type, index) in props.typeActivities"
                      :key="index"
                      :value="type.id"
                      :selected="type.id == form.type_activity_id"
                    >
                      {{ type.name }}
                    </option>
                  </select>
