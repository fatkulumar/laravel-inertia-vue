...
function editHeadOrganization(data) {
  form.id = data.id;
  form.name = data.name;
...
function deleteHeadOrganization(id, name) {
  const konfirm = confirm(`Apakah anda yakin ingin menghapus ${name}?`);
  if (!konfirm) return;
  form.delete(`/dashboard/head-organization/delete/${id}`, {
    preserveScroll: true,
    onSuccess: (e) => {
      toast("success", "Berhasil");
      resetForm();
...
function toggleCheckbox(id) {
  ...
  if (props.HeadOrganizations.to == totalChecked) {
...
function checkedAll() {
  ...
  if (checboxAll.checked == true) {
    ...
    props.HeadOrganizations.data.forEach((data) => {
...
function deleteClassRoomChoice() {
  ...
  if (!konfirm) return;
  formCheckbox.post("/dashboard/head-organization/destroy", {
    preserveScroll: true,
    onSuccess: () => {
      formCheckbox.id = [];
          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                >
                  ...
                  >
                    <tr>
                      ...
                      <th scope="col" class="px-6 py-3">
                        <p>Tanggal Mulai Khidmah</p>
                      </th>
                      <th scope="col" class="px-6 py-3">
                        <p>Tanggal Selesai Khidmah</p>
                      </th>
                      <th scope="col" class="px-6 py-3">
                  ...
                  <tbody>
                    <tr
                      v-for="(item, index) in props.HeadOrganizations.data"
                      :key="index"
              ...
              <Pagination
                ...
                :links="props.HeadOrganizations.links"
              />
            </div>
          </div>
        </div>
      ...
      >
        <div class="relative p-4 w-full max-w-7xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form
              @submit.prevent="addHeadOrgaization"
              ...
              <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2">
                  ...
                  <select
                    ...
                    placeholder="Nama Kategori"
                  >
                    <option :selected="form.status == null" value="">
                      Pilih Status
                    </option>
