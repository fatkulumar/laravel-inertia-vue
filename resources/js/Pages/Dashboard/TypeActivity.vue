...
function addTypeActivity() {
  form.post("/dashboard/type-activity/store", {
    preserveScroll: true,
        onSuccess: (e) => {
...
function editTypeActivity(data) {
  form.id = data.id;
  form.name = data.name;
  modalRoom("show");
}

function deleteTypeActivity(id, name) {
  const konfirm = confirm(`Apakah anda yakin ingin menghapus ${name}?`);
  if (!konfirm) return;
  form.delete(`/dashboard/type-activity/delete/${id}`, {
    preserveScroll: true,
    onSuccess: () => {
      resetForm();
...
function toggleCheckbox(id) {
  ...
  if (props.typeActivities.to == totalChecked) {
...
function checkedAll() {
  ...
  if (checboxAll.checked == true) {
    ...
    props.typeActivities.data.forEach((data) => {
...
function deleteTypeActivityChoice() {
  const konfirm = confirm(
    `Apakah anda yakin ingin menghapus data ini?`
  );
  if (!konfirm) return;
  formCheckbox.post("/dashboard/type-activity/destroy", {
    preserveScroll: true,
    onSuccess: () => {
      formCheckbox.id = [];
      toast("success", "Data Berhasil Dihapus");
            ...
            <div class="p-6 text-gray-900">
              <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                >
                    ...
                    <tr>
                      ...
                      <th scope="col" class="px-6 py-3">
                        <div class="flex gap-1">
                          ...
                          <div
                            @click="deleteTypeActivityChoice()"
                            v-show="deleteChoice"
                            title="Hapus"
                  ...
                  <tbody>
                    <tr
                      v-for="(item, index) in props.typeActivities.data"
                      :key="index"
                ...
                <Pagination
                  ...
                  :links="props.typeActivities.links"
                />
              </div>
            </div>
          </div>
      ...
      >
        <div class="relative p-4 w-full max-w-7xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form
              @submit.prevent="addTypeActivity"
            ...
            >
              ...
              >
                {{ form.id ? "Update Kegiatan" : "Add Kegiatan" }}
              </button>
            </form>
          </div>
        </div>
