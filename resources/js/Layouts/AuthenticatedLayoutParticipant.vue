...
import SidebarParticipant from '@/Components/SIdebar/SidebarParticipant.vue';
...
onMounted(() => {
    ...
    document.addEventListener('mouseup', closeOnEscape);
})

const closeOnEscape = (e) => {
    if (showingNavigationDropdown.value && e.key === 'Escape') {
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard.committee')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
                            </div> -->
                            ...
                            <button
                                ...
                                class="h-8 mt-4 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out bg-white"
                            >
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <div
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 cursor-pointer"
                                            >
