...
class TotalFemaleParticipantByScheduleClassExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize
{
    use Exportable;
    ...
    public function query()
    {
        ...
        ->whereHas('profile', function ($query) {
            $query->where('gender', 'perempuan'); // Menambahkan filter berdasarkan gender
        });
    }
}
